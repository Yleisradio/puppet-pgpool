...
describe 'pgpool' do
  ...
  describe 'Test standard installation' do
    ...
    it { should contain_service('pgpool').with_enable('true') }
  ...
  describe 'Test customizations - template' do
    let(:params) { {:template => "pgpool/spec.erb" , :options => { 'opt_a' => 'value_a' } } }

    it 'should generate a valid template' do
      content = catalogue.resource('file', 'pgpool.conf').send(:parameters)[:content]
  ...
  describe 'Test customizations - source' do
    ...
    it 'should request a valid source ' do
      ...
      content.should == "puppet://modules/pgpool/spec"
    end
    it 'should request a valid source dir' do
      content = catalogue.resource('file', 'pgpool.dir').send(:parameters)[:source]
      content.should == "puppet://modules/pgpool/dir/spec"
    end
    it 'should purge source dir if source_dir_purge is true' do
      content = catalogue.resource('file', 'pgpool.dir').send(:parameters)[:purge]
      content.should == true
    end
  end

  describe 'Test customizations - custom class' do
    let(:params) { {:my_class => "pgpool::spec" } }
  ...
  describe 'Test service autorestart' do
    ...
    it 'should not automatically restart the service, when service_autorestart => false' do
      content = catalogue.resource('file', 'pgpool.conf').send(:parameters)[:notify]
  ...
  describe 'Test Puppi Integration' do
    ...
    it 'should generate a puppi::ze define' do
      content = catalogue.resource('puppi::ze', 'pgpool').send(:parameters)[:helper]
  ...
  describe 'Test OldGen Module Set Integration' do
    ...
    it 'should generate puppi resources ' do 
      content = catalogue.resource('puppi::ze', 'pgpool').send(:parameters)[:ensure]
